...
class ConfigApi {
    ...
    setupRoutes(app) {
        ...
        console.log('[ConfigApi] Registering custom threshold endpoints...');
        
        // Test endpoint to verify routes are working
        app.get('/api/test-thresholds', (req, res) => {
            res.json({ success: true, message: 'Threshold routes are working!' });
        });
